                ...
                <ul class="row mega-menu"><!-- start mega menu-->
                    <li class="col-3 mega-menu-box">
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">لپ تاپ</a></li>
                            <li><a href="javascript:void(0)">لوازم جانبی لپ تاپ</a></li>
                            <li><a href="javascript:void(0)">تبلت</a></li>
                            <li><a href="javascript:void(0)">مچ بند و ساعت هوشمند</a></li>
                            <li><a href="javascript:void(0)">مودم و تجهیزات شبکه</a></li>
                        </ul>
                    </li>
                    <li class="col-3 mega-menu-box" >
                        <ul>
                            <li class="menu-title"><i class="fa fa-angle-left"></i>زیبایی و سلامت</li>
                            <li><a href="javascript:void(0)">لوازم آرایشی</a></li>
                            <li><a href="javascript:void(0)">لوازم بهداشتی</a></li>
                            <li><a href="javascript:void(0)">عطر،ادکلن،اسپری و ست</a></li>
                            <li><a href="javascript:void(0)">ابزار سلامت و طبی</a></li>
                            <li><a href="javascript:void(0)">لوازم شخصی برقی</a></li>
                        </ul>
                        <ul>
                            <li class="menu-title"><i class="fa fa-angle-left"></i>مد و پوشاک</li>
                            <li><a href="javascript:void(0)">لباس زنانه</a></li>
                    ...
                    <li class="col-3 mega-menu-box" >
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">صوتی و تصویری</a></li>
                            <li><a href="javascript:void(0)">لوازم برقی خانگی</a></li>
                            <li><a href="javascript:void(0)">فرش ماشینی، دستبافت، تابلو</a></li>
                        </ul>
                        <ul>
                            <li class="menu-title"><i class="fa fa-angle-left"></i>اسباب بازی، کودک و نوزاد</li>
                            <li><a href="javascript:void(0)">پوشاک کودک و نوزاد</a></li>
                            <li><a href="javascript:void(0)">بازی و سرگرمی کودک</a></li>
                            <li><a href="javascript:void(0)">سلامت، ایمنی و مراقبت</a></li>
                        </ul>
                    </li>
                    <li class="col-3 mega-menu-box" >
                        <ul>
                            <li class="menu-title"><i class="fa fa-angle-left"></i>کتاب و لوازم تحریر</li>
                            <li><a href="javascript:void(0)">کتاب و مجله</a></li>
                            <li><a href="javascript:void(0)">کتاب صوتی</a></li>
                            <li><a href="javascript:void(0)">لوازم تحریر</a></li>
                        </ul>
...
<main>
    <div class="container">
        ...
        <div class="category-box"><!-- start category box -->
            ...
            <div class="row">
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-laptop"></i><p>کالای دیجیتال</p><p class="text-info">+825000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-tools"></i><p> ابزار و تجهیزات </p><p class="text-info">+146000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-tshirt"></i><p>مد و پوشاک</p><p class="text-info">+658000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-baby-carriage"></i><p>کودک و نوزاد</p><p class="text-info">+69000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-shopping-basket"></i><p>کالاهای سوپرمارکتی</p><p class="text-info">+60000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-heartbeat"></i><p>زیبایی و سلامت</p><p class="text-info">+98000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-couch"></i><p>خانه و آشپزخانه</p><p class="text-info">+477000 کالا</p></a></div>
                <div class="col-4 col-md-3 col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-pencil-ruler"></i><p>کتاب و لوازم تحریر </p><p class="text-info">+251000 کالا</p></a></div>
                <div class="col-4 col-md col-lg text-center"><a href="javascript:void(0)"><i class="fas fa-campground"></i><p>ورزش و سفر</p><p class="text-info">+31000 کالا</p></a></div>
            </div>
