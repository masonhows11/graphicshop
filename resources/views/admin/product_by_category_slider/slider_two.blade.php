...
@section('dash_main_content')
    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.sliders_management') }} / {{ __('messages.slider_no_two') }}</h3>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    @foreach( $sliderCategory as $item)
                        <tr class="text-center">
                            ...
                            <td>
                                <form action="{{ route('admin.slider_two.destroy',$item->id) }}" method="get" class="d-inline">
                                    @csrf
        ...
        <div class="row bg-white p-5 mt-4">
            <form action="{{ route('admin.slider_two.store') }}" id="create-form" method="post">
                @csrf
