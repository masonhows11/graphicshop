...
use App\Models\SliderOne as SliderOneModel;
class SliderOne extends Component
{
    ...
    public function mount(){
        $slider = SliderOneModel::first();
        $this->products = null;
        $this->category_title = null;
        if($slider) {
            $this->products = Product::where('category_id', '=', SliderOneModel::select('category_id')->first()->category_id)->get();
    ...
    {
        return view('livewire.front.slider.slider-one')
