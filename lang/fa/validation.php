...
return [
    ...
    */
    'attributes' => [
		...
		"file" => "فایل",
		"full_name" => "نام کامل",
        'title_persian' => 'نام به فارسی',
        'title_english' => 'نام به انگلیسی',
        'weight' => 'وزن',
        'length' => 'طول',
        'height' => 'ارتفاع',
        'width' => 'عرض',
        ...
        'short_description' => 'چکیده',
        'full_description' => 'توضیحات',
        'seo_desc' => 'توضیحات سئو',
        'is_active' => 'فعال شده',
        'origin_price' => 'قیمت',
        'status' => 'وضعیت',
        'meta_key' => 'عنوان',
        ...
        'marketable_number'=>'تعداد قابل فروش بودن',
        'body' => 'متن پیام',
        'numbers' => 'تعداد',
        'deliver' => 'تحویل دهنده',
        ...
        'delivery_time_unit' => 'واحد مدت زمان',
        'icon' => 'آیکون',
        'logo' => 'لوگو',
        'keywords' => 'کلمات کلیدی',
        'rules' => 'قوانین استفاده از سایت',
        'token' => 'کد فعال سازی',
        'image_path' => 'تصویر',
        'category' => 'دسته بندی',
        'default' => 'پیش فرض',
